...
# original source: https://github.com/MinaProtocol/mina/tree/develop/src/app/rosetta/download-missing-blocks.sh
...
POSTGRES_USERNAME=${3}
POSTGRES_PASSWORD=${4}
PG_CONN=postgres://${POSTGRES_USERNAME}:${POSTGRES_PASSWORD}@127.0.0.1:5432/${POSTGRES_DBNAME}
